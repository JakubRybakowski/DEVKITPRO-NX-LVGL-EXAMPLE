...
#define LV_CACHE_DEF_SIZE       (1024*1024U)
...
#define LV_USE_FS_STDIO 1
    ...
    #define LV_FS_STDIO_PATH "romfs:/"
    #define LV_FS_STDIO_CACHE (1024*1024U)    /*>0 to cache this number of bytes in lv_fs_read()*/
#endif
...
#if LV_USE_FS_WIN32
    #define LV_FS_WIN32_LETTER 'S'
    #define LV_FS_WIN32_PATH "romfs:/"
...
#if LV_USE_FS_MEMFS
    #define LV_FS_MEMFS_LETTER 'S'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
#endif
